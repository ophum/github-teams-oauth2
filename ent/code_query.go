...
func (cq *CodeQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Code, error) {
	...
	if withFKs {
		_spec.Node.Columns = append(_spec.Node.Columns, code.ForeignKeys...)
	}
	...
	if query := cq.withUser; query != nil {
		if err := cq.loadUser(ctx, query, nodes, nil,
			func(n *Code, e *User) { n.Edges.User = e }); err != nil {
			return nil, err
		}
	}
...
func (cq *CodeQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Code, init func(*Code), assign func(*Code, *User)) error {
